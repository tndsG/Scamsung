...
WDIR=$(pwd)
banner (){
	echo -e "\n\033[1;34mSamsung Firmware Extractor 3.0 - By Ravindu Deshan ----- Edited by TndsG\033[0m"
...
get_link(){
	echo "The Link Stuff"
	FIRMWARE_LINK="https://05-samfw."
